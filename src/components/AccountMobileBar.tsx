...
// Sticky mobile bar for account pages - full width, edge-to-edge, sticks below navbar
export default function AccountMobileBar({ title, onOpen }: Props) {
  ...
  return (
    <div
      className="lg:hidden fixed left-0 right-0 z-30 bg-white border-b border-gray-200 px-4 py-3 flex items-center gap-3 shadow-sm"
