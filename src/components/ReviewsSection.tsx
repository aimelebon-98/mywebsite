...
const testimonials: Testimonial[] = [
  ...
  { name: "Sarah Chen",     avatar: "SC", rating: 5,
    comment: "The quality is outstanding. I have worn them daily for 3 months and they still look brand new. Highly recommend NewDealZone!",
    commentFr: "La qualité est exceptionnelle. Je les porte tous les jours depuis 3 mois et elles sont comme neuves. Je recommande vivement NewDealZone!",
