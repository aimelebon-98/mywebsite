      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
          <div className="relative px-8 py-16 lg:px-16 lg:py-20 text-center">
            ...
            {status === "success" ? (
              <div className="inline-flex items-center gap-2 px-8 py-4 bg-green-500/20 border border-green-500/30 text-green-400 rounded-2xl text-lg font-semibold">
              ...
              <form onSubmit={handleSubmit} className="max-w-md mx-auto">
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  >
                    {status === "loading" ? "Subscribing..." : <><ArrowRight className="w-4 h-4" /> Subscribe</>}
                  </button>
                </div>
