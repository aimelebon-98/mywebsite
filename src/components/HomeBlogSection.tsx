      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-6">
          {posts.map(p => (
            ...
            >
              {/* Image */}
              <Link prefetch={false} href={`/${locale}/blog/${locale === "fr" && p.slugFr ? p.slugFr : p.slug}`} className="block relative aspect-[16/10] bg-gray-100 overflow-hidden">
                {p.coverImage ? (
                  <Image
                    src={p.coverImage}
                    alt={p.title}
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                {/* Title */}
                <Link prefetch={false} href={`/${locale}/blog/${locale === "fr" && p.slugFr ? p.slugFr : p.slug}`}>
