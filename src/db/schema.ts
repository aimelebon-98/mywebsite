import { pgTable, text, numeric, integer, boolean, timestamp, uuid , varchar } from "drizzle-orm/pg-core";
...
export const affiliates = pgTable("affiliates", {
  ...
  loginOtpCode: varchar("login_otp_code", { length: 10 }),
