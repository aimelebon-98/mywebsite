...
export async function GET(req: NextRequest) {
  ...
  try {
    const tokenUrl = `https://graph.facebook.com/v19.0/oauth/access_token?client_id=${process.env.FACEBOOK_APP_ID}&client_secret=${process.env.FACEBOOK_APP_SECRET}&redirect_uri=${encodeURIComponent((process.env.NEXT_PUBLIC_APP_URL || "https://www.newdealzone.com") + "/api/auth/facebook/callback")}&code=${code}`;
