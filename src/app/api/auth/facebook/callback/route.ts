...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const tokenUrl = `https://graph.facebook.com/v19.0/oauth/access_token?client_id=${appId}&client_secret=${appSecret}&redirect_uri=${encodeURIComponent(appUrl + "/api/auth/facebook/callback")}&code=${code}`;
