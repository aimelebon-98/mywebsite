...
import { LifeBuoy, Loader2, Sparkles } from "lucide-react";
          ...
          <div className="lg:grid lg:grid-cols-[240px_1fr] lg:gap-8">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                <LifeBuoy className="w-7 h-7 text-[#CA3F2E]" />
                <h1 className="text-3xl font-black text-gray-900">{isFr ? "Tickets de support" : "Support Tickets"}</h1>
              </div>
              <div className="bg-white border border-gray-200 rounded-2xl p-12 text-center">
                ...
                <p className="text-sm text-gray-500 max-w-md mx-auto">{isFr ? "Cr\u00e9ez et suivez vos tickets de support. Cette section sera activ\u00e9e bient\u00f4t." : "Create and track support tickets. This section will be enabled soon."}</p>
              </div>
            </div>
          </div>
        </div>
