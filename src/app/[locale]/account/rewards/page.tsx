          ...
          <div className="lg:grid lg:grid-cols-[240px_1fr] lg:gap-8">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                <Gift className="w-7 h-7 text-[#CA3F2E]" />
                <h1 className="text-3xl font-black text-gray-900">{isFr ? "R\u00e9compenses et coupons" : "Rewards & Coupons"}</h1>
              </div>
              <div className="bg-white border border-gray-200 rounded-2xl p-12 text-center">
                ...
                <p className="text-sm text-gray-500 max-w-md mx-auto">{isFr ? "Gagnez des points, obtenez des coupons de r\u00e9duction. Bient\u00f4t disponible." : "Earn points, get discount coupons, and refer friends. Coming soon."}</p>
              </div>
            </div>
          </div>
        </div>
