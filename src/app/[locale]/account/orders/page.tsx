...
import { Package, Loader2, Clock, CheckCircle, Truck, MapPin, XCircle } from "lucide-react";
      ...
      <main className="min-h-screen bg-gray-50 pt-20 lg:pt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-8">
          <div className="lg:grid lg:grid-cols-[260px_1fr] lg:gap-8">
            ...
            <div>
              <AccountMobileBar title={isFr ? "Mes commandes" : "My Orders"} onOpen={() => setMenuOpen(true)} />
              <h1 className="text-2xl lg:text-3xl font-black text-gray-900 mb-6">{isFr ? "Mes commandes" : "My Orders"}</h1>
