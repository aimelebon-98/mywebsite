...
export default function OrdersPage() {
  ...
  return (
    <AccountShell title={isFr ? "Mes commandes" : "My Orders"}>
      {loading ? (
        ...
        <div className="space-y-4">
          {orders.map(order => {
            ...
            return (
              <div key={order.id} className="bg-white border border-gray-200/80 rounded-2xl p-5 hover:shadow-md transition shadow-sm">
