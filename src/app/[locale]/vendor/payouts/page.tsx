...
export default function VendorPayoutsPage() {
  ...
  return (
    <div className="max-w-4xl">
      <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">VendorPayoutsPayouts</h1>
      <p className="text-gray-500 text-sm mb-8">VendorPayoutsPayment history and requests</p>
