...
export default function VendorSignupPage() {
  ...
  function handleSocialLogin(provider: string) {
    window.location.href = "/api/auth/" + provider + "?locale=" + locale + "&role=vendor";
  }
        ...
        <div className="bg-gray-900 rounded-2xl p-6 border border-gray-800">
          ...
          <div className="space-y-3 mb-6">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl bg-white text-gray-800 font-medium hover:bg-gray-100 transition"
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl bg-[#1877F2] text-white font-medium hover:bg-[#166FE5] transition"
            >
