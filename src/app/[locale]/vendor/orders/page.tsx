...
export default function VendorOrdersPage() {
  ...
  return (
    <div className="max-w-4xl">
      <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">VendorOrdersMy Orders</h1>
      <p className="text-gray-500 text-sm mb-8">VendorOrdersTrack your sales and fulfillment</p>
