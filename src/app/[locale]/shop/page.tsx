...
import MobileShopFilterButton from "@/components/MobileShopFilterButton";
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-3 pb-0 lg:py-0">
        ...
        <div className="hidden lg:block lg:mb-6 mb-0 -mx-4 sm:-mx-6 lg:-mx-8 lg:mx-0 overflow-x-auto scrollbar-hide">
